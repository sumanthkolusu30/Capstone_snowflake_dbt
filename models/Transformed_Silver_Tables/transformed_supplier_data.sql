...
SELECT 
    ...
    CASE 
        WHEN SUBSTR(REGEXP_REPLACE(TRIM(CONTACT_PHONE),'[^0-9,X,+]',''),1,2) NOT LIKE '+1' THEN '+1' || REGEXP_REPLACE(TRIM(CONTACT_PHONE),'[^0-9,X,+]','')
    ELSE REGEXP_REPLACE(TRIM(CONTACT_PHONE),'[^0-9,X,+]','')
